      ...
      try {
        if (user?.email) {
          const response = await fetch(
            `https://script.google.com/macros/s/AKfycbyhj4X4koy5xRMWw6QYCwY9UghvzqE8euHryzMJNY1Fnt76DQQasObJ1vRuMrqGqY_9Kg/exec?sheetId=1mXw76hqsqPZG3hBrcuujOOQe2CUp8uEoe7_6cM4nbvQ&email=${user.email}`
          )
